                        ...
                        <div className="flex flex-col lg:flex-row lg:items-center lg:h-[54px] gap-4 pb-0 lg:pb-0 ">
                            ...
                            <div className="flex gap-6 items-center mx-auto">
                                ...
                                <a
                                    ...
                                    href="https://www.facebook.com/flyjetlevel/"
                                    aria-label="Facebook"
                                >
                                    <FaFacebookF />
                                </a>
                                ...
                                <a
                                    className="border border-[#858585] rounded-full p-2 text-[#858585]"
                                    href="https://www.instagram.com/flyjetlevel/?hl=en"
                                ...
                                <a
                                    className="border border-[#858585] rounded-full p-2 text-[#858585]"
                                    href="https://www.linkedin.com/company/flyjetlevel/"
                                    aria-label="LinkedIn"
                                >
                                    <FaLinkedinIn />
                                </a>
                ...
                <div className="max-w-[1800px] mx-auto flex flex-col lg:flex-row text-[#f0f1f2] gap-5 mt-8 py-4">
                    <div className="flex gap-5 flex-col md:flex-row lg:flex-col text-[11px]">
                        ...
                        <div className="flex flex-row gap-3 md:mx-auto lg:mx-0">
                            ...
                            <Link
                                href="/jetlevel-aviation-standard-terms-and-conditions"
                                className="hover:text-blue"
                            >
                                Terms of Use
                            </Link>
                    ...
                    <p className="flex-1 text-[#858585] text-[9px] ">
                        ...
                        Aviation, LLC are fully certified by The Federal
                        Aviation Administration and The U.S Department of
                        Transportation under Part 135 regulations. Carriers are
                        solely responsible for the air transportation arranged
                        on behalf of JetLevel Aviation, LLC. JetLevel Aviation,
                        LLC does not own or operate any aircraft. JetLevel
                        Aviation, LLC is not a direct or indirect air carrier.
                        All flights chartered through JetLevel Aviation, LLC are
                        operated by Part 135 Air Carriers or Foreign Civil
                        Aviation Authority (CAA) equivalent that operate and
                        exercise full operational control over those flights at
                        all times.
                    </p>
                </div>
            </div>
