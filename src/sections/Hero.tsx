...
const Hero: React.FC<HeroProps> = ({ image, title, subtitle, tagline }) => {
    return (
        <section className={`flex flex-col md:min-h-[75vh] md:justify-center lg:justify-end bg-center bg-cover text-center text-white bg-no-repeat px-5 md:px-10 lg:px-20 py-10 md:py-5 `} 
