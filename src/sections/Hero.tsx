...
const Hero = () => {
    return (
        <section className="flex flex-col md:min-h-[75vh] md:justify-center lg:justify-end bg-hero-background bg-center bg-cover text-center text-white bg-no-repeat px-5 py-10 md:py-5 2xl:pb-[5%]">
