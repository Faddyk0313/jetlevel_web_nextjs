...
const OurOffices = () => {
    return (
        <div className="bg-cover bg-center bg-ourOffices-background max-w-[1800px] mx-auto  ">
            <div className="bg-black bg-opacity-50 flex flex-col text-white px-5 justify-center py-20 md:py-32 ">
