...
const MeetOwner = () => {
    return (
        <section className="bg-blue-background px-5 py-10 bg-no-repeat bg-cover">
            <div className="flex flex-col md:flex-row items-center max-w-[1800px] mx-auto">
                <div className="mb-5 md:min-w-[45%] ">
                    <Image
                ...
                <div className="text-white pl-5 py-10">
                    <h4 className='mb-5'>MEET THE OWNER</h4>
                    <h2 className='mb-5'>Hi, I'm Ricky</h2>
                    <p className='mb-[15px] details text-[#bbbbbb]'>
                    ...
                    <div className='my-5'>
                        <p className='details text-[#bbbbbb] pb-2'><span className='text-cyan-400'>✓&nbsp;</span> 5,000+ world's safest jets</p>
                        <p className='details text-[#bbbbbb] pb-2'><span className='text-cyan-400'>✓&nbsp;</span> 15+ years in business</p>
                        <p className='details text-[#bbbbbb] pb-2'><span className='text-cyan-400'>✓&nbsp;</span> A+ BBB rating</p>
                        <p className='details text-[#bbbbbb] pb-2'><span className='text-cyan-400'>✓&nbsp;</span> 1,000+ annual charters</p>
                    </div>
                    <button className='text-white px-5 py-2 my-4 rounded-full text-lg bg-gradient-to-r from-[#59a6c8] via-[#6cc3e8] to-[#4f94b8] transition-all ease-linear hover:-translate-y-1'>
