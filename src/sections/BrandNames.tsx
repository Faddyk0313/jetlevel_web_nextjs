...
const BrandNames = () => {
    return (
        <section className="flex flex-col md:flex-row lg:flex-col xl:flex-row md:min-h-[15vh] justify-center xl:justify-start items-center lg:items-start xl:items-center max-w-[1800px] mx-auto pt-7 pb-2 px-5 md:px-10 lg:px-20">
            ...
            <div className="grid grid-cols-3 lg:flex  gap-1 justify-between items-center w-[90%] lg:w-full xl:w-[90%]">
