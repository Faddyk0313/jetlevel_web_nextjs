    ...
    <header className="bg-black sticky top-0 z-20">
      <nav className="text-white sticky flex items-center justify-between py-5  px-3 max-w-[1800px] mx-auto ">
        ...
        <div id="contact-request" className="hidden lg:flex min-w-60 text-xs min-[1200px]:text-sm items-center gap-2 justify-end">
          ...
          <a className="cursor-pointer whitespace-nowrap bg-gradient-to-br from-[#a94442] via-[#d9534f] to-[#c9302c] text-white no-underline py-2.5 px-3 rounded-full transition-all ease-in duration-300 hover:-translate-y-0.5 ">
            Request a Quote
          </a>
        </div>
      </nav>
