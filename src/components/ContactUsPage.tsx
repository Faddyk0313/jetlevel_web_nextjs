...
const ContactUsPage = () => {
  return (
    <>
     <div className="bg-[url('https://jetlevel.com/wp-content/uploads/2023/05/private-jet-charter-services.jpg')] overlay bg-cover bg-center bg-no-repeat h-[130px] sm:h-[190px] lg:h-[300px] max-h-[300px] flex items-center justify-center">
