      ...
      <div className="flex justify-between mt-8 flex-wrap gap-y-7">
        {
          ...
          <div
            key={index}
            className={`${array?.length === 6 ? 'w-[32%] max-[700px]:w-full': 'w-[14%] max-[700px]:w-full'} h-[270px] border-[3px] transition-all ease-in duration-100 hover:-translate-y-2 hover:border-blue cursor-pointer group bg-cover rounded-lg relative box-border`}
