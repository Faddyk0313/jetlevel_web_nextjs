      ...
      <div className='flex flex-col justify-center gap-y-[20px] p-8'>
        <div className='px-5 md:px-10 xl:px-20 py-7 max-w-[1800px] mx-auto w-full'>
         ...
         <div className='border-b pb-6 mb-8'>
          <div className='flex'>
            <div className='w-[60%]'>
              <h3 className='text-[27px] mb-4'>On-Demand Luxury, Unparalleled and Unmatched</h3>
            ...
            <div className='w-[35%]' data-aos="fade-left">
         ...
         <div className='border-b pb-6 mb-8'>
          <h3 className='text-[35px] mb-8'>How It Works</h3>
          ...
          <p className='mb-8 leading-7 text-[16px] text-[#727982]'><span>Step 1 – </span>Request a Quote: Reach out to us through our online form, email, or phone. Share with us your travel itinerary details, including dates, destinations, and passenger information.</p>
          ...
          <p className='mb-8 leading-7 text-[16px] text-[#727982]'><span>Step 3 –</span>Confirm and Fly: After you give us the green light, we prepare your jet and provide all the necessary details. All you need to do is arrive and enjoy your flight.</p>
         </div>

         <div className='border-b pb-6 mb-8 flex'>
          <div className='w-[60%]'>
            <h3 className='text-[35px] mb-8'>Unique Value Proposition</h3>
         ...
         <div className='mt-[50px] border-b pb-6 mb-8'>
          <h3 className='text-[35px]'>Benefits of On-Demand Private Jet Charter Service</h3>
         ...
         <div className='mt-[50px] border-b pb-6 mb-8'>
          <h3 className='text-[35px] mb-8'>On-Demand Private Jet Charter Prices Estimation</h3>
          <p className='leading-7 text-[16px] text-[#727982] mb-8'>We offer transparent, competitive pricing for our on-demand private jet service. Costs will vary based on flight duration, aircraft type, and additional services requested. We also offer bespoke packages and deals tailored to your specific needs. For payment, we accept a range of options and provide clear guidelines on deposits and cancellations.</p>
          <Table column={tableColumns} data={tableData} button={false} />
          <p className='italic mt-6 text-[#727982] text-center text-sm'>Please be aware that the prices listed above are only approximate values; the actual cost for each trip can vary based on numerous factors, and we cannot guarantee these exact amounts for every individual flight</p>
         </div>

         <div className='mt-[50px] border-b pb-6 mb-8 flex justify-between items-center'>
          <div className='w-[48%]'>
            <h3 className='text-[35px] mb-4'>Who Owns The Planes?</h3>
         ...
         <div className='mt-[50px] border-b pb-6 mb-8'>
          <h3 className='text-[35px] mb-4'>How Are Planes Paired with Trips?</h3>
         ...
         <div className='mt-[50px] border-b pb-6 mb-8'>
          <h3 className='text-[35px] mb-4'>What are the Safety Standards of the Aircraft Used?</h3>
         ...
         <div className='w-full'>
          ...
          <div className='flex items-center justify-between mt-10 border-b pb-6 mb-8'>
            <div className='w-[48%]'>
              <h3 className='text-[35px] mb-4'>Peak Season Charter Flights</h3>
            ...
            <div className='w-[48%]'>
              <h3 className='text-[35px] mb-4'>Last Minute Charter Flights</h3>
          ...
          <div className='border-b pb-6 mb-8'>
            <h3 className='text-[35px] mb-4'>Customer Testimonials</h3>
          ...
          <div className='mt-[50px] border-b pb-6 mb-8'>
            <h3 className='text-[35px] mb-4'>Frequently Asked Questions about Instant Quotes</h3>
